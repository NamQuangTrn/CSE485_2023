...
if(isset($_POST['btn_submit']))
{
    ...
    if($_POST['password'] == ''){
        $flag = false;
        $error['pass'] = 'Không được bỏ trống';
    }
    if($flag == true){
        $user = $_POST['username'];
        $pass = $_POST['password'];
 
        $result = checkLogin($conn , $user , $pass);
        if($result == null){
            echo "Tài khoản mật khẩu k đúng";
        } else{
            if($result['role'] == '1'){
                // echo 'admin';
                    ...
                    <div class="card-body">
                        <form action="login.php" method="POST">
                            ...
                            <div class="form-group">
                                <input type="submit" value="Login" name="btn_submit" class="btn float-end login_btn">
                            </div>
                        </form>
                    </div>
